    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{route('order.store')}}" enctype="multipart/form-data">
            ...
            <div>
                ...
                <x-jet-input size="4" id="uzsakovas" class="block mt-1 w-full" type="text" name="uzsakovas" :value="old('uzsakovas')" />
            </div>
            ...
            <div class="mt-4">
                <x-jet-label for="pastabos" value="{{ __('pastabos') }}" :value="old('pastabos')"/>
